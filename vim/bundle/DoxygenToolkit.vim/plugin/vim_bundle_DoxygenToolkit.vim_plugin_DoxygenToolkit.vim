...
" For cambricon
if !exists("g:DoxygenToolkit_parTag")
  let g:DoxygenToolkit_parTag = "@par "
endif
if !exists("g:DoxygenToolkit_noteTag")
  let g:DoxygenToolkit_noteTag = "@note"
endif
if !exists("g:DoxygenToolkit_warningTag")
  let g:DoxygenToolkit_warningTag = "@warning"
endif
if !exists("g:DoxygenToolkit_formulaName")
  let g:DoxygenToolkit_formulaName = "Formula"
endif
if !exists("g:DoxygenToolkit_seealsoName")
  let g:DoxygenToolkit_seealsoName = "See Also"
endif
if !exists("g:DoxygenToolkit_depName")
  let g:DoxygenToolkit_depName = "API Dependency"
endif
if !exists("g:DoxygenToolkit_typeName")
  let g:DoxygenToolkit_typeName = "DataType"
endif
if !exists("g:DoxygenToolkit_layoutName")
  let g:DoxygenToolkit_layoutName = "Data Layout"
endif
if !exists("g:DoxygenToolkit_scaleName")
  let g:DoxygenToolkit_scaleName = "Scale Limitation"
endif
if !exists("g:DoxygenToolkit_requireName")
  let g:DoxygenToolkit_requireName = "Requirements"
endif
if !exists("g:DoxygenToolkit_egName")
  let g:DoxygenToolkit_egName = "Example"
endif
if !exists("g:DoxygenToolkit_refName")
  let g:DoxygenToolkit_refName = "Reference"
endif
if !exists("g:DoxygenToolkit_performanceName")
  let g:DoxygenToolkit_performanceName = "Performance"
endif

"Cambricon keyword ends
...
" cambricon functions
" compactDoc
function! <SID>compactDoc()
  if( g:DoxygenToolkit_compactDoc != "yes" )
    exec "normal o".substitute( s:interCommentTag, "[[:blank:]]*$", "", "" )
  endif
endfunction
" insert formula
function! <SID>InsertFormula()
  call s:compactDoc()
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_parTag.g:DoxygenToolkit_formulaName
  exec "normal o".s:interCommentTag."\\n"
  exec "normal o".s:interCommentTag."Your formula description here"
  exec "normal o".s:interCommentTag."\\n"
  exec "normal o".s:interCommentTag."[Formula]"
endfunction
" insert return
function! <SID>InsertReturn()
  call s:compactDoc()
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_returnTag
  exec "normal o".s:interCommentTag."\\n"
  exec "normal o".s:interCommentTag."Your return value description here"
endfunction
" insert datatype
function! <SID>InsertDataType()
  call s:compactDoc()
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_parTag.g:DoxygenToolkit_typeName
  exec "normal o".s:interCommentTag."- "."Your main description here"
  exec "normal o".s:interCommentTag."  "."<b>Important description here</b>"
  exec "normal o".s:interCommentTag."  "."- "."tensor: "."datatype constraint"
  exec "normal o".s:interCommentTag."\\rst"
  exec "normal o".s:interCommentTag."  "."Your table here."
  exec "normal o".s:interCommentTag."\\endrst"
endfunction
" insert datalayout
function! <SID>InsertDataLayout()
  call s:compactDoc()
  exec "normal o".s:interCommentTag."// Optional, can be remove"
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_parTag.g:DoxygenToolkit_layoutName
  exec "normal o".s:interCommentTag."- "."Your main description here"
  exec "normal o".s:interCommentTag."  "."<b>Important description here</b>"
  exec "normal o".s:interCommentTag."  "."- "."tensor: "."layout constraint"
  exec "normal o".s:interCommentTag."\\rst"
  exec "normal o".s:interCommentTag."  "."Your table here."
  exec "normal o".s:interCommentTag."\\endrst"
endfunction
" insert scale
function! <SID>InsertScaleLimitation()
  call s:compactDoc()
  exec "normal o".s:interCommentTag."// Optional, can be remove"
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_parTag.g:DoxygenToolkit_scaleName
  exec "normal o".s:interCommentTag."- "."Your main description here"
  exec "normal o".s:interCommentTag."  "."<b>Important description here</b>"
  exec "normal o".s:interCommentTag."  "."- "."\\p "."[Formula for attr]"
  exec "normal o".s:interCommentTag."  "."- "."tensor: "."\\p "."[Formula for tensor]"
endfunction
" insert performance
function! <SID>InsertPerformance()
  call s:compactDoc()
  exec "normal o".s:interCommentTag."// Optional, can be remove"
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_parTag.g:DoxygenToolkit_performanceName
  exec "normal o".s:interCommentTag."- "."Your main description here"
endfunction
" insert note
function! <SID>InsertNote()
  call s:compactDoc()
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_noteTag
  exec "normal o".s:interCommentTag."- "."Your description here/None"
endfunction
" insert require
function! <SID>InsertReq()
  call s:compactDoc()
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_parTag.g:DoxygenToolkit_requireName
  exec "normal o".s:interCommentTag."- "."dependency.h"
endfunction
" insert example
function! <SID>InsertExample()
  call s:compactDoc()
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_parTag.g:DoxygenToolkit_egName
  exec "normal o".s:interCommentTag."- "."See sample codes in xxx/xxx"
endfunction
" insert ref
function! <SID>InsertRef()
  call s:compactDoc()
  exec "normal o".s:interCommentTag."// Optional, can be remove"
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_parTag.g:DoxygenToolkit_refName
  exec "normal o".s:interCommentTag."- "."website/paper"
endfunction
" insert warning
function! <SID>InsertWarning()
  call s:compactDoc()
  exec "normal o".s:interCommentTag."// Optional, can be remove"
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_warningTag
  exec "normal o".s:interCommentTag."- "."Your warning here"
endfunction
" insert dep
function! <SID>InsertDep()
  call s:compactDoc()
  exec "normal o".s:interCommentTag."// Optional, can be remove"
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_parTag.g:DoxygenToolkit_depName
  exec "normal o".s:interCommentTag."- "."Before calling this funtion to [], you need to"
  exec "normal o".s:interCommentTag."  "."[]"
endfunction
" insert ref
function! <SID>InsertAlso()
  call s:compactDoc()
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_parTag.g:DoxygenToolkit_seealsoName
  exec "normal o".s:interCommentTag."Relevant API Name/None"
endfunction

" Start with recommended statement.
function! <SID>InsertStartStatement(doc)
  if ( a:doc.type == "enum" )
      exec "normal A"."Enumeration variables describing ..."
  elseif ( a:doc.type == "struct")
      exec "normal A"."The ".a:doc.name." is a structure describing ..."
  else
    if( a:doc.name != "None" )
      exec "normal A".a:doc.name." "
    endif
  endif
endfunction
""""""""""""""""""""""""""
...
function! <SID>DoxygenCommentFunc()
  ...
  if( s:CheckFileType() == "cpp" )
    ...
    let l:enumPattern      = '\%(\<enum class\>\|\<enum\>\)[[:blank:]]\+\zs'.l:someNameWithNamespacePattern.'\ze.*\%('.l:endDocPattern.'\)'
    let l:namespacePattern = '\<namespace\>[[:blank:]]\+\zs'.l:someNamePattern.'\ze[[:blank:]]*\%('.l:endDocPattern.'\)'

    let l:types = { "enum": l:enumPattern, "class": l:classPattern, "struct": l:structPattern, "namespace": l:namespacePattern }
  else
  ...
  if( l:doc.type == "" )
    ...
    if( s:CheckFileType() == "cpp" )
      if( match( l:lineBuffer, '(' ) == -1 )
        if( match( l:lineBuffer, '\<enum class\>' ) != -1 )
          let l:doc.type = 'enum'
  ...
  if( g:DoxygenToolkit_compactOneLineDoc =~ "yes" && l:doc.returns != "yes" && len( l:doc.params ) == 0 )
    ...
    exec "normal O".strpart( s:startCommentTag, 0, 1 )
    if( l:doc.type != "attribute" && l:doc.type != "function" )
      exec "normal A".strpart( s:startCommentTag, 1 )."@".l:doc.type." ".l:doc.name
    endif
  else
    let s:compactOneLineDoc = "no"
    let l:insertionMode = s:StartDocumentationBlock()
    if( l:doc.type != "attribute" && l:doc.type != "function" )
      " todo(yangyang): It may require an extra space before 's:interCommentTag' with some vim configuration.
      exec "normal ".l:insertionMode.s:interCommentTag."@".l:doc.type." ".l:doc.name
    endif
  endif
  ...
  call s:InsertStartStatement(l:doc)

  if( l:doc.type =~ "struct" )
    call s:InsertFormula()
  endif
  ...
  "formula+datatype+layout+scale+performance|note+requirement+example+see
  "also+reference
  if ( l:doc.type == "class" )
    exec "normal o".s:interCommentTag."// This part is for Node class, remove it if it's not a node"
    call s:InsertFormula()
    call s:InsertDataType()
    call s:InsertDataLayout()
    call s:InsertScaleLimitation()
    call s:InsertPerformance()
    exec "normal o".s:interCommentTag."// Node part ends"
    call s:InsertNote()
    call s:InsertReq()
    call s:InsertExample()
    call s:InsertAlso()
  endif
  "note+warning+apidep+seealso
  if ( l:doc.type == "function" )
    call s:InsertNote()
    call s:InsertWarning()
    call s:InsertDep()
    call s:InsertAlso()
  endif
